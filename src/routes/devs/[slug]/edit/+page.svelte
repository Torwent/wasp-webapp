...
>
	<!-- Preview -->
	<div>
		<details class="container mx-auto mb-6 max-w-2xl flex-grow">
			<summary>Preview dev page</summary>
			<div class="flex justify-between">
				...
				<div class="flex justify-evenly w-64">
					...
					{#if data.paypal_id !== "" && data.paypal_id !== null}
						<form
			...
			<div class="container mx-auto max-w-2xl flex-grow">
				<h2 class="text-amber-500 dark:text-amber-200 text-center py-6">Information:</h2>
				<article
	...
	<!-- Fom -->
	<div class="w-full">
		{#if $user.id === data.id || $user.id === "4dbcf43d-cc8a-48e3-aead-2c55a3f302ee"}
			<form class="form my-6 w-full" on:submit|preventDefault={handleSubmit}>
				<!-- Name and username -->
				<div class="flex justify-between w-full">
					<!-- Real Name -->
					<div class="flex flex-col text-sm mb-2 w-[45%]">
