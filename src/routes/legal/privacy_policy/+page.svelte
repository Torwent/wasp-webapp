<script lang="ts">
	...
	const headTitle = "Privacy Policy - WaspScripts"
	const headDescription = "WaspScripts Privacy Policy"
	const headKeywords =
...
<main class="container mx-auto my-6 max-w-4xl flex-grow">
	<div class="grid mx-auto max-w-4xl">
		...
		<div class="flex mx-auto my-6">
			Updated on: {new Date(currentPolicy.created_at).toLocaleString(userLocale)}
		</div>
	...
	<article class="max-w-md md:max-w-4xl mx-auto prose dark:prose-invert py-6">
		<Markdown src={currentPolicy.content} />
	</article>
</main>
