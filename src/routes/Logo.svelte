...
<!-- Website Logo -->
<div
	class="group my-auto flex transition duration-300 hover:text-primary-300 dark:hover:text-primary-200"
>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 701.99 552.97" class="mr-3 h-8 fill-current">
		<g
			id="WaspLayer"
	...
	<span class="text-lg font-bold">WaspScripts</span>
</div>
