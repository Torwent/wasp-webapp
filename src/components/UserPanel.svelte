<script>
	...
	const handleUserChange = async () => {
		updateUsername($profile.id, username)
	}
</script>
		...
		<form on:submit|preventDefault={handleLogin} class="py-6 flex flex-col ">
			...
			<div class="pt-2 flex justify-center items-center flex-wrap space-x-2">
				...
				<button
					...
					class="inline-block px-4 py-4 mb-2 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
					style="background-color: #ffffff;"
					on:click={() => setProvider("google")}
				>
